 ...
 * @author  
 */
namespace JetShopModule\Order\Delivery\PersonalTakeover\CeskaPostaBalikovna;
...
{
	protected static string $method_code = 'Order.PersonalTakeover.CeskaPostaBalikovna';
