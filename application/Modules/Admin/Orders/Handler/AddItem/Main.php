...
class Handler_AddItem_Main extends Handler {
	...
	protected function catch_product( Form $form ) : bool
	{
		...
		return $this->order->addProduct( $product, $qty )->hasChange();
	}
	...
	protected function catch_gift( Form $form ) : bool
	{
		...
		return $this->order->addGift( $product, $qty )->hasChange();
	}
	...
	protected function catch_discount( Form $form ) : bool
	{
		...
		$discount->setVatRate( $this->order->getPricelist()->getDefaultVatRate() );
		
		
		return $this->order->addDiscount( $discount )->hasChange();
	}
	...
	protected function catch_payment( Form $form ) : bool
	{
		...
		return $this->order->addPaymentFee( $method, $fee )->hasChange();
	}
