...
class Handler_Note_MessageGenerator_Apology extends Handler_Note_MessageGenerator
{
	...
	{
		$this->view->setVar('number', $this->complaint->getNumber() );
	...
	public function generateText(): string
	{
		...
		} while( Discounts_Code::getByCode( $d_code, $this->complaint->getShop() ) );
		
		$discounts_code = new Discounts_Code();
		$discounts_code->setShop( $this->complaint->getShop() );
