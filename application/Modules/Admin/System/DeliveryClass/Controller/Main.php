...
class Controller_Main extends Mvc_Controller_Default
{
	 ...
	 * @var ?DeliveryClass
	 */
	protected ?DeliveryClass $delivery_class = null;
	...
	public function getControllerRouter() : Mvc_Controller_Router_AddEditDelete
	{
		if( !$this->router ) {
			$this->router = new Mvc_Controller_Router_AddEditDelete(
				$this,
				function($id) {
					return (bool)($this->delivery_class = DeliveryClass::get($id));
				},
				[
	...
	public function add_Action() : void
	{
		...
		$delivery_class = new DeliveryClass();
		...
		if( $delivery_class->catchAddForm() ) {
			...
			$this->logAllowedAction( 'Delivery Class created', $delivery_class->getId(), $delivery_class->getInternalName(), $delivery_class );

			UI_messages::success(
				Tr::_( 'Delivery Class <b>%ITEM_NAME%</b> has been created', [ 'ITEM_NAME' => $delivery_class->getInternalName() ] )
			);

			Http_Headers::reload( ['id'=>$delivery_class->getId()], ['action'] );
		}
	...
	public function edit_Action() : void
	{
		...
		if( $delivery_class->catchEditForm() ) {
			...
			$delivery_class->save();
			$this->logAllowedAction( 'Delivery Class updated', $delivery_class->getId(), $delivery_class->getInternalName(), $delivery_class );
	...
	public function delete_Action() : void
	{
		...
		if( Http_Request::POST()->getString( 'delete' )=='yes' ) {
			...
			$this->logAllowedAction( 'Delivery Class deleted', $delivery_class->getId(), $delivery_class->getInternalName(), $delivery_class );
