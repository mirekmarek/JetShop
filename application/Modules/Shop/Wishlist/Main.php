 ...
 * @author  
 */
namespace JetApplicationModule\Shop\Wishlist;
 ...
 *
 */
class Main extends Application_Module implements Shop_Managers_Wishlist, Shop_ModuleUsingTemplate_Interface
{
	...
	{
		if(!$this->session) {
			$this->session = new Session('wishlist');
		}
