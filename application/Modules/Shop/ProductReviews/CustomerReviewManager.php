...
class CustomerReviewManager {
	...
	public function getPossibleProducts() : array
	{
		...
		return Product_ShopData::getActiveList( $ids );
	}
	...
	public function getWriteReviewProduct(): ?Product_ShopData
	{
		if(!$this->write_review_product_id) {
			return null;
		}
		
		return Product_ShopData::get( $this->write_review_product_id );
	}
	...
	public function getWriteReviewForm() : Form
	{
		if(!$this->new_review_form) {
			...
			$this->new_review->setShop( $customer->getShop() );
