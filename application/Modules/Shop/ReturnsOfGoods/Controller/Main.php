 ...
 * @author  
 */
namespace JetApplicationModule\Shop\ReturnsOfGoods;
...
class Controller_Main extends MVC_Controller_Default
{
	...
	protected function getOrder() : ?Order
	{
		...
		$order_number_field->setValidator( function() use ($order_number_field, $customer, &$order) {
			...
			$order = Order::getByNumber( $on, Shops::getCurrent() );
	...
	protected function getProduct( Order $order ) : ?Product_ShopData
	{
	...
	protected function enterProblem( Order $order, Product_ShopData $product ) : void
	{
