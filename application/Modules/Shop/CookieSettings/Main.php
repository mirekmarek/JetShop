 ...
 * @author  
 */
namespace JetApplicationModule\Shop\CookieSettings;
 ...
 *
 */
class Main extends Shop_CookieSettings_Manager implements Shop_ModuleUsingTemplate_Interface
{
	...
	protected function initGroups() :array {
		...
		$marketing = new Shop_CookieSettings_Group();
		$marketing->setCode( Shop_CookieSettings_Group::MARKETING );
		...
		$mesurement = new Shop_CookieSettings_Group();
		$mesurement->setCode( Shop_CookieSettings_Group::MESUREMENT );
		...
		$stats = new Shop_CookieSettings_Group();
		$stats->setCode( Shop_CookieSettings_Group::STATS );
