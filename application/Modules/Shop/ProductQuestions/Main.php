 ...
 *
 */
class Main extends Application_Module implements Shop_Managers_ProductQuestions, Shop_ModuleUsingTemplate_Interface
{
	...
	protected function getNewQuestionForm( Product_ShopData $product ) : Form
	{
		if(!$this->new_question_form) {
			$customer = Customer::getCurrentCustomer();
			
			$this->new_question = new ProductQuestion();
			$this->new_question->setShop( Shops::getCurrent() );
