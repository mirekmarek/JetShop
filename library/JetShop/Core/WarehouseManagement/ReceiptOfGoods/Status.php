...
abstract class Core_WarehouseManagement_ReceiptOfGoods_Status extends EShopEntity_Status {
	
	protected static string $base_status_class = WarehouseManagement_ReceiptOfGoods_Status::class;
