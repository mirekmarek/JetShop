...
abstract class Core_WarehouseManagement_StockVerification_Status extends EShopEntity_Status {
	
	protected static string $base_status_class = WarehouseManagement_StockVerification_Status::class;
