...
abstract class Core_WarehouseManagement_StockVerification_Status_Pending extends WarehouseManagement_StockVerification_Status
{
	...
	public function getPossibleFutureStatuses(): array
	{
		...
		$statuses[] = WarehouseManagement_StockVerification_Status_Done::getAsPossibleFutureStatus();
		$statuses[] = WarehouseManagement_StockVerification_Status_Cancelled::getAsPossibleFutureStatus();
