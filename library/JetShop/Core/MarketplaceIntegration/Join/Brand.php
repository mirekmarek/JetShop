...
abstract class Core_MarketplaceIntegration_Join_Brand extends Entity_WithShopRelation
{
	...
	public static function get( string $marketplace_code, Shops_Shop $shop, int $brand_id  ) : static|null
	{
		$i = static::load( [
