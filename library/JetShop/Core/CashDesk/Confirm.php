...
use JetApplication\CashDesk_AgreeFlag;
use JetApplication\Customer;
use JetApplication\Customer_MailingSubscribe;

trait Core_CashDesk_Confirm {

	/**
	 * @var CashDesk_AgreeFlag[]
	 */
	...
	public function addAgreeFlag( CashDesk_AgreeFlag $agree_flag ) : void
	{
	...
	public function getAgreeFlag( string $code ) : ?CashDesk_AgreeFlag
	{
