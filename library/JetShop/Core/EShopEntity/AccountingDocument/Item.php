...
abstract class Core_EShopEntity_AccountingDocument_Item extends DataModel_Related_1toN {
	...
	/**
	 * @var EShopEntity_AccountingDocument_Item_SetItem[]
	 */
	#[DataModel_Definition(
		type: DataModel::TYPE_DATA_MODEL,
		data_model_class: EShopEntity_AccountingDocument_Item_SetItem::class
	)]
	...
	public function isPhysicalProduct() : bool
	{
		return (
			...
			$this->getType()==EShopEntity_AccountingDocument_Item::ITEM_TYPE_GIFT
		);
	}
	...
	public function isVirtualProduct() : bool
	{
		return (
			...
			$this->getType()==EShopEntity_AccountingDocument_Item::ITEM_TYPE_VIRTUAL_GIFT
		);
	}
	...
	{
		return $this->type == EShopEntity_AccountingDocument_Item::ITEM_TYPE_DISCOUNT;
	}
	...
	public function setupPricePerUnit( EShopEntity_Price $price ) : void
	{
	...
	public function setupProduct( Pricelist $pricelist, Product_EShopData $product, float $number_of_units ) : void
	{
		...
		if($product->isVirtual()) {
			$this->setType( EShopEntity_AccountingDocument_Item::ITEM_TYPE_VIRTUAL_PRODUCT );
		} else {
			$this->setType( EShopEntity_AccountingDocument_Item::ITEM_TYPE_PRODUCT );
		}
		...
		if( $product->isSet() ) {
			...
			foreach( $product->getSetItems() as $set_item ) {
				/**
				 * @var EShopEntity_AccountingDocument_Item_SetItem $item_set_item
				 */
	...
	public function setupGift( Pricelist $pricelist, Product_EShopData $product, float $number_of_units ) : void
	{
		...
		if($product->isVirtual()) {
			$this->setType( EShopEntity_AccountingDocument_Item::ITEM_TYPE_VIRTUAL_GIFT );
		} else {
			$this->setType( EShopEntity_AccountingDocument_Item::ITEM_TYPE_GIFT );
		}
	...
	{
		$this->setType( EShopEntity_AccountingDocument_Item::ITEM_TYPE_DISCOUNT );
		...
		$discount_price = new class extends EShopEntity_Price {};
	...
	/**
	 * @return EShopEntity_AccountingDocument_Item_SetItem[]
	 */
	...
	public static function createFrom( EShopEntity_AccountingDocument_Item $source ) : static
	{
		$new_item = new static();
		...
		/**
		 * @var EShopEntity_AccountingDocument_Item_SetItem $set_item_class_name
		 */
		$set_item_class_name = static::getSetItemClassName();
