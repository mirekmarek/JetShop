...
abstract class Core_EShopEntity_AccountingDocument_Item_SetItem extends DataModel_Related_1toN {
	...
	public static function createFrom( EShopEntity_AccountingDocument_Item_SetItem $source ) : static
	{
		$new_item = new static();
