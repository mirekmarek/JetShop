...
abstract class Core_EShopEntity_ChangeHistory extends EShopEntity_Basic implements EShopEntity_HasEShopRelation_Interface
{
	...
	/**
	 * @var EShopEntity_ChangeHistory_Item[]
	 */
	#[DataModel_Definition(
		type: DataModel::TYPE_DATA_MODEL,
		data_model_class: EShopEntity_ChangeHistory_Item::class
	)]
	...
	) : void
	{
		...
		/**
		 * @var EShopEntity_ChangeHistory_Item $item
		 */
		$item = new $class_name();
	...
	/**
	 * @return EShopEntity_ChangeHistory_Item[]
	 */
