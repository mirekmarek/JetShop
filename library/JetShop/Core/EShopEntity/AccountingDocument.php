...
abstract class Core_EShopEntity_AccountingDocument extends EShopEntity_Basic implements
	...
	Context_ProvidesContext_Interface
{
	...
	/**
	 * @var EShopEntity_AccountingDocument_Item[]
	 */
	#[DataModel_Definition(
		type: DataModel::TYPE_DATA_MODEL,
		data_model_class: EShopEntity_AccountingDocument_Item::class
	)]
	...
	public function addItem( EShopEntity_AccountingDocument_Item $item ) : void
	{
		$this->items[] = $item;
	}
	...
	public function setIssuerAddress( EShopEntity_Address $address ) : void
	{
	...
	public function getIssuerAddress() : EShopEntity_Address
	{
	...
	public function setCustomerAddress( EShopEntity_Address $address ) : void
	{
	...
	public function getCustomerAddress() : EShopEntity_Address
	{
		$address = new EShopEntity_Address();
	...
	public static function createByOrder( Order $order ) : static
	{
		...
		foreach($order->getItems() as $item) {
			if($item->getTotalAmount()!=0) {
				/**
				 * @var EShopEntity_AccountingDocument_Item $item_class_name
				 */
