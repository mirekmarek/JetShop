...
abstract class Core_Delivery_Method_EShopData extends Entity_WithEShopData_EShopData implements Entity_HasPrice_Interface
{
	...
	public function getAvailableTimerActions() : array
	{
		...
		$set_free_limit = new class( $eshop, $this->free_delivery_limit ) extends Timer_Action {
			...
			{
				/**
				 * @var Delivery_Method_EShopData $entity
				 */
