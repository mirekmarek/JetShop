...
use JetApplication\Entity_Definition_Property;
use ReflectionClass;

#[Attribute(Attribute::TARGET_CLASS | Attribute::TARGET_PROPERTY | Attribute::IS_REPEATABLE)]
abstract class Core_Entity_Definition extends BaseObject
{
	...
	protected static function read( ReflectionClass $reflection, array $attributes ) : static
	{
		...
		$property_definitions = Attributes::getClassPropertyDefinition( $reflection, Entity_Definition::class );
		foreach( $property_definitions as $property_name => $definition ) {
			$def->properties[$property_name] = Entity_Definition_Property::read( $definition );
		}
	...
	public static function get( string|object $object_or_class ) : ?static
	{
		...
		if(!array_key_exists($class_name, static::$definitions)) {
			...
			$attributes = Attributes::getClassDefinition( $reflection, Entity_Definition::class );
	...
	/**
	 * @return Entity_Definition_Property[]
	 */
