...
class Core_Exports_ExportCategory_Parameter_Value extends EShopEntity_WithEShopRelation
{
	...
	public static function get( EShop $eshop, string $export_code, string $category_id, string $parameter_code, int $product_id ) : ?static
	{
	 ...
	 * @return static[]
	 */
	public static function getForProduct( EShop $eshop, string $export_code, string $category_id, int $product_id ) : array
	{
		$where = $eshop->getWhere();
		$where[] = 'AND';
		$where['export_code'] = $export_code;
