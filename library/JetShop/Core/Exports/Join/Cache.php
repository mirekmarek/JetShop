...
abstract class Core_Exports_Join_Cache extends Entity_WithShopRelation
{
	...
	public static function get( string $export_code, Shops_Shop $shop, string $cache_key  ) : static|null
	{
		return static::load( [
