 ...
 *
 */
abstract class Core_Shop_OAuth_BackendModule extends Application_Module
{
	...
	abstract protected function getClientId( ?Shops_Shop $shop=null ) : string;
	
	abstract protected function getClientSecret( ?Shops_Shop $shop=null ) : string;
	
	abstract protected function getOAuthURL( ?Shops_Shop $shop=null ) : string;
	
	abstract protected function getTokenURL( ?Shops_Shop $shop=null ) : string;
	...
	public function handleOAuthServiceReturn( Shop_OAuth_UserHandler $user_handler ) : bool
	{
