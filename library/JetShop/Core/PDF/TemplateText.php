...
#[DataModel_Definition(
	name: 'pdf_templates',
	database_table_name: 'pdf_templates',
)]
#[EShopEntity_Definition(
	entity_name_readable: 'E-mail template',
	admin_manager_interface: Application_Service_Admin_Content_PDFTemplates::class,
	separate_tab_form_shop_data: true
)]
abstract class Core_PDF_TemplateText extends EShopEntity_WithEShopData implements EShopEntity_Admin_WithEShopData_Interface
{
	use EShopEntity_Admin_WithEShopData_Trait;
	
	/**
	 * @var PDF_TemplateText_EShopData[]
	 */
	#[DataModel_Definition(
		type: DataModel::TYPE_DATA_MODEL,
		data_model_class: PDF_TemplateText_EShopData::class
	)]
	protected array $eshop_data = [];
	
	
	
	public function getEshopData( ?EShop $eshop = null ): PDF_TemplateText_EShopData
	{
	...
	{
		$templates = PDF_Template::findAllTemplates();
