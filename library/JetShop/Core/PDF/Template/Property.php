...
abstract class Core_PDF_Template_Property {
	...
	/**
	 * @var PDF_Template_Property_Param[]
	 */
	...
	public function addParam( string $type, string $name, string $description='' ) : PDF_Template_Property_Param
	{
		$param = new PDF_Template_Property_Param();
		$param->setType( $type );
		$param->setName( $name );
