...
abstract class Core_Supplier_GoodsOrder_VirtualStatus extends EShopEntity_VirtualStatus {
	
	protected static string $base_status_class = Supplier_GoodsOrder_VirtualStatus::class;
