...
abstract class Core_Complaint_DeliveryOfClaimedGoods extends BaseObject {
	public const CODE = null;
	
	protected static string $base_status_class= Complaint_DeliveryOfClaimedGoods::class;
	...
	protected static function add( Complaint_DeliveryOfClaimedGoods $status ) : void
	{
		static::$list[$status->getCode()] = $status;
		
		uasort( static::$list, function( Complaint_DeliveryOfClaimedGoods $a, Complaint_DeliveryOfClaimedGoods $b ) {
