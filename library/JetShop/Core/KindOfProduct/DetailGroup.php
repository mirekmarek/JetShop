...
#[DataModel_Definition(
	name: 'kind_of_product_detail_group',
	database_table_name: 'kind_of_product_detail_groups',
	parent_model_class: KindOfProduct::class,
	id_controller_class: DataModel_IDController_Passive::class,
	default_order_by: ['+priority']
)]
abstract class Core_KindOfProduct_DetailGroup extends DataModel_Related_1toN
{
	...
	/**
	 * @var KindOfProduct_DetailGroup_Property[]
	 */
	#[DataModel_Definition(
		type: DataModel::TYPE_DATA_MODEL,
		data_model_class: KindOfProduct_DetailGroup_Property::class
	)]
	...
	public function addProperty( int $property_id ) : bool
	{
		...
		$detail_group_property = new KindOfProduct_DetailGroup_Property();
	...
	public function sortProperties( array $sort ) : bool
	{
		...
		uasort( $this->properties, function( KindOfProduct_DetailGroup_Property $a, KindOfProduct_DetailGroup_Property $b ) {
	...
	/**
	 * @return KindOfProduct_DetailGroup_Property[]
	 */
	...
	public function getProperty( int $property_id ) : ?KindOfProduct_DetailGroup_Property
	{
