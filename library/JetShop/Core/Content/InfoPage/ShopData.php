...
#[DataModel_Definition(
	name: 'content_info_page_shop_data',
	database_table_name: 'content_info_page_shop_data',
	parent_model_class: Content_InfoPage::class
)]
abstract class Core_Content_InfoPage_ShopData extends Entity_WithShopData_ShopData
{
	#[DataModel_Definition(
	...
	public function publish() : void
	{
		...
		if(!$page) {
			...
			$old_page_data_file =
				MVC::getBase($shop->getBaseId())
					->getPagesDataPath($shop->getLocale())
		...
		$page_data_file = MVC::getBase($shop->getBaseId())
			->getPagesDataPath($shop->getLocale())
			.$page->getRelativePathFragment().'/'
			.SysConf_Jet_MVC::getPageDataFileName();
